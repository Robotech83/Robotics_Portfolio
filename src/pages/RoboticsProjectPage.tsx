  ...
  return (
    <section className="robotics-page">
      ...
      <header className="robotics-header">
        ...
        <p>Humanoid robotics, kinematics, control systems, and robotics tooling.</p>
      </header>

      <div className="robotics-grid">
        <div className="robotics-card flagship-card">
          ...
          <p className="robotics-desc">
            Offline humanoid robotics platform built on Raspberry Pi. Combines
            voice interaction, facial recognition, memory, and modular AI systems
        ...
        <div className="robotics-card">
          ...
          <p className="robotics-desc">
            Demonstrates forward kinematics used in real robotic systems,
            including Sonny OS, bridging mathematical modeling with physical
            robot control.
          </p>
